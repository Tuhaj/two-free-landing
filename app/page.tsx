      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="https://twofree.tuhaj.pl/" target="_blank">
            ...
            >
              <Link href="https://github.com/Tuhaj/two-free" target="_blank">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-slate-400">
              <Link href="https://twofree.tuhaj.pl/" target="_blank" className="hover:text-cyan-400 transition-colors">
                Play Game
              </Link>
              <Link
                href="https://github.com/Tuhaj/two-free"
